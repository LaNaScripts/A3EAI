...
call compile preprocessFileLineNumbers format ["%1\A3EAI_config.sqf",A3EAI_installedFolder];

//Load custom A3EAI settings file.
if ((!isNil "A3EAI_overrideEnabled") && {A3EAI_overrideEnabled}) then {call compile preprocessFileLineNumbers format ["%1\A3EAI_settings_override.sqf",A3EAI_installedFolder]};
