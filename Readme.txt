...
Installing A3EAI
---
1. Download A3EAI from the A3EAI GitHub Page: https://github.com/dayzai/A3EAI
2. Locate the file you downloaded (A3EAI-master.zip) and extract it to a folder.
3. Open the extracted folder and open the Installation Package folder. Copy the contents of this file (Addons, A3EAI_config.sqf, A3EAI_custom_defs)
